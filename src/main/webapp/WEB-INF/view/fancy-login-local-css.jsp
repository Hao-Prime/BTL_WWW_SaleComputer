...
<body>
	...
	<div>
		<div id="loginbox" style="margin-top: 50px;margin-left: 450px;"
			class="mainbox col-md-3 col-md-offset-2 col-sm-6 col-sm-offset-2">

			<div class="panel panel-info">

				<div class="panel-heading">
					<div class="panel-title">Sign In new</div>
				</div>
				...
				<div style="padding-top: 30px" class="panel-body">
					...
					<div style="padding-top:10px;padding-left:7px;text-align: center;"><a href="${pageContext.request.contextPath}">Back To Home</a>
					</div>
				</div>
			</div>
		</div>
